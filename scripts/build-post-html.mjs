...
const SITE_URL = 'https://greenido.github.io/daily-blog-news';
...
function buildPostHtmlPage(post) {
  ...
  const jsonLd = {
    ...
    author: { '@type': 'Person', name: 'AI Insights Desk' },
...
<head>
  ...
  <meta name="author" content="AI Insights Desk">
  ...
  <meta property="article:author" content="AI Insights Desk">
    ...
    <article>
      <header class="mb-8">
        ...
        <div class="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400">
          <span>By <strong class="text-gray-700 dark:text-gray-300">AI Insights Desk</strong></span>
      ...
      <div class="grid gap-8 sm:grid-cols-3">
        <div>
          <div class="flex items-center gap-2 mb-3">
            ...
            <span class="font-bold text-sm">AI Insights Daily</span>
          </div>
          <p class="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">Daily AI-powered insights on IT operations, cybersecurity, and compliance.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">Content generated by Google Gemini AI. IT &amp; Security solutions by <a href="https://espressolabs.com/" target="_blank" rel="noopener" class="text-brand-600 dark:text-brand-400 hover:underline">Espresso Labs</a>.</p>
        </div>
      </div>
      <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-800 text-center text-xs text-gray-400">
        &copy; <span id="year"></span> AI Insights Daily. Posts are AI-generated and may not reflect the latest information.
      </div>
    </div>
  </footer>
